...
By default we want spaces and not tabs. Everyone else seems to like 4 so we will default to 4.
...
#+begin_src emacs-lisp
  ...
  (use-package org
    ...
    (setq org-agenda-files
          '("~/OneDrive - Intel Corporation/org/stuff.org"
            "~/OneDrive - Intel Corporation/org/1n1.org"))
...
Add in the hooks for reveal.js generator
...
Add disasteer to provide assembly output
...
Beardbolt is a Godbolt Compiler Explorer thingy for emacs. It is a lighter weight version of RMSbolt.

[[https://github.com/joaotavora/beardbolt][Bearbolt GitHub]]
...
Customize:
Emacs customization variables _or_ file-local cookies like this:
...
// Local Variables:
// beardbolt-command: "g++ --std=c++20 -03"
...
(use-package plantuml-mode
  :init
    ...
    (setq plantuml-jar-path "~/sandbox/tools/plantuml-mit-1.2025.0.jar")
    (setq org-plantuml-jar-path (expand-file-name "~/sandbox/tools/plantuml-mit-1.2025.0.jar"))
...
This package provides out-of-the-box formatting hooks for buffer/file types. It relies on a variety of external tools. Form info here: https://github.com/lassik/emacs-format-all-the-code
